...
kubectl set image deployments/client-deployment client=shandak/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=shandak/multi-worker:$SHA